...
# --- Professional Stacked Chart ---
        ...
        # Grabs the actual column names generated by your version of pandas-ta
        ...
        fig.update_yaxes(title_text="Momentum", row=2, col=1, showgrid=True, gridcolor='rgba(128, 128, 128, 0.2)')
